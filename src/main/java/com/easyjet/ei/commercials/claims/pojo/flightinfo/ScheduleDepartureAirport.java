...
public class ScheduleDepartureAirport implements Serializable{
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScheduleDepartureAirport) == false) {
            return false;
        }
        ScheduleDepartureAirport rhs = ((ScheduleDepartureAirport) other);
