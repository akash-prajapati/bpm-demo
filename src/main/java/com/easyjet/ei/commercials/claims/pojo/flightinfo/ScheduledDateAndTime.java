...
public class ScheduledDateAndTime implements Serializable{
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScheduledDateAndTime) == false) {
            return false;
        }
        ScheduledDateAndTime rhs = ((ScheduledDateAndTime) other);
