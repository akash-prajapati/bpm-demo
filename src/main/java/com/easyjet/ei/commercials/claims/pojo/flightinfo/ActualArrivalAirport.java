...
public class ActualArrivalAirport implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActualArrivalAirport) == false) {
            return false;
        }
        ActualArrivalAirport rhs = ((ActualArrivalAirport) other);
