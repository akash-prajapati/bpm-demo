...
public class ScheduleArrivalAirport implements Serializable{
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ScheduleArrivalAirport) == false) {
            return false;
        }
        ScheduleArrivalAirport rhs = ((ScheduleArrivalAirport) other);
